...
(function (global) {
    ...
    { id: 'u-profil-pvd', title: 'U-Profil 14×13×1 mm Edelstahl PVD-beschichtet 6 Farben', handle: 'u-profil-14x13x1mm-2500mm-pvd', material: 'edelstahl', einbau: 'auf-fliese', colors: ['edelstahl-poliert','edelstahl-gebuerstet','bronze-matt','messing-matt','graphit-matt','kupfer-matt'], abschluss: [], price: '49,90', desc: 'Schmales U-Profil 14×13×1 mm, Edelstahl PVD-beschichtet, in 6 Farben, 250 cm.' },
    { id: 'loft-flachprofil-eufb19', title: 'Loft-Flachprofil Aluminium 19 mm, 2,4 m, für Ganzglas-Sprossen, 5 Oberflächen', handle: 'loft-flachprofil-aluminium-19-mm-2-4-m-fur-ganzglas-sprossen-5-oberflachen-art-nr-eufb19', material: 'alu', einbau: 'auf-fliese', colors: ['schwarz-matt','messing-matt','silber-matt','chrom-poliert','messing-poliert'], abschluss: [], price: '13,30', desc: 'Schmales Aluminium-Flachprofil 19 mm für Sprossen und Glasteiler auf Ganzglas-Anlagen, Loft- und Industrial-Optik, 2,4 m je Stange, in 5 Oberflächen.' }
,
    ...
    { id: 'set-bronze-rund', title: 'Komplett-Set Bronze matt gebürstet, runde Stabistange und U-Profil', handle: 'komplett-set-bronze-matt-geburstet-stabilisierungsstange-u-profil-glasdusche', type: 'profil', material: 'edelstahl', einbau: 'auf-fliese', colors: ['bronze-matt'], abschluss: ['silikonverklebung'], price: '209,90', desc: 'U-Profil mit Edelstahlmantel 2400 mm und runde Stabistange, beides im selben Bronzeton.' },
    { id: 'set-bronze-eckig', title: 'Komplett-Set Bronze matt gebürstet, eckige Stabistange und U-Profil', handle: 'komplett-set-bronze-matt-geburstet-eckige-stabilisierungsstange-u-profil-glasdusche', type: 'profil', material: 'edelstahl', einbau: 'auf-fliese', colors: ['bronze-matt'], abschluss: ['silikonverklebung'], price: '219,90', desc: 'U-Profil mit Edelstahlmantel 2400 mm und eckige Stabistange, beides im selben Bronzeton.' },
    { id: 'emily-glasprofil', title: 'Drehbares Duschtürprofil Emily Hebe-Senk Glas-Glas (6 mm)', handle: 'drehbares-duschturprofil-typ-emily-glas-glas', type: 'profil', material: 'alu', einbau: 'auf-fliese', colors: ['chrom-poliert','schwarz-matt','messing-matt','silber-matt'], abschluss: ['silikonverklebung'], price: '208,90', priceMax: '251,90', desc: 'Gegenstück zum Emily-Wandprofil: 180° Pendeltür mit Festteil aus Glas, 6 mm ESG, mit Hebe-Senk.' },
];
